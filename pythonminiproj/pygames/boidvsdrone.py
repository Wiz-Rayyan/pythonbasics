...
class Drone:
    ...
    def update(self, keys):
        if keys[pygame.K_LEFT]: self.x -= DRONE_SPEED
        if keys[pygame.K_RIGHT]: self.x += DRONE_SPEED
        if keys[pygame.K_UP]: self.y -= DRONE_SPEED
        if keys[pygame.K_DOWN]: self.y += DRONE_SPEED
